...
function HomePage() {
    ...
    return (
        <>
            <header style={{ backgroundImage: `url(${background})`, backgroundSize: "cover " }} className="masthead text-light text-center p-5">
                <div className="container d-flex align-items-center flex-column">
                    <img className="masthead-avatar" src={avatar} alt="Raphael's Face" />

                    <p className="masthead-subheading font-weight-light mb-5">Full Stack Web Developer</p>
